...
#define DCM_EXTENSIONS_ENABLE 1

#define DCM_BLINK_LED_ENABLE 1
#define DCM_BLINK_LED_PORT PORTD
#define DCM_BLINK_LED_DDR DDRD
#define DCM_BLINK_LED_BIT 7

#define DCM_AUTOSTART_ENABLE 1
#define DCM_AUTOSTART_SECONDS 10
...
{
	DDRD &= ~(1 << 6); // bit tasta: intrare
    PORTD |= (1 << 6); // activeaza pull-up pt tasta
